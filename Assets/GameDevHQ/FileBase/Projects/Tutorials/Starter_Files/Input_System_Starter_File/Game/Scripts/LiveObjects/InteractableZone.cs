...
namespace Game.Scripts.LiveObjects
{
    public class InteractableZone : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            //Subscriptions
            //Press No Hold 'E'
            Manager_Input.interactWithEnvironment += InteractionNOPressHold;
            //Press & Hold 'E'
            Manager_Input.pressHoldFalseState += InteractionPressHoldFalseState;
        }
        ...
        void InteractionPressHoldFalseState()
        {
            if (_inZone == true)
            {
        ...
        void InteractionPressHoldTrueState()
        {
            if (_inZone == true)
            {
                if (_keyState == KeyState.PressHold)
